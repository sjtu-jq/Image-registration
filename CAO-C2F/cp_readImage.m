...
function [I1_gray, I2_gray, I1_rgb, I2_rgb, Filename1, Filename2, pathname] = cp_readImage(distort,path,file1,file2)
...
if nargin == 0
    distort = 0;
    [Filename1,pathname] = uigetfile('*.*','pick image1');
    ...
    if sum( 'dat'== Filename1(end-2:end))==3
        ...
        [Filename2,pathname] = uigetfile([pathname '*' Filename1(end-3:end)],'pick image2');
...
elseif nargin  == 4
    I1 = imread([path file1]);
    I2 = imread([path file2]);
    pathname = path;
    Filename1 = file1;
    Filename2 = file2;
else
